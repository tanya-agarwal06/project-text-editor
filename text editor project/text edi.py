...
lab1=Label(TopF,image=new_file_icon)
lab1.pack(side=LEFT)
save_icon = PhotoImage(file='save1.gif')
lab2=Label(TopF,image=save_icon)
lab2.pack(side=LEFT)
cut_icon = PhotoImage(file='cut1.gif')
lab3=Label(TopF,image=cut_icon)
lab3.pack(side=LEFT)
copy_icon = PhotoImage(file='copy.gif')
lab4=Label(TopF,image=copy_icon)
lab4.pack(side=LEFT)
paste_icon = PhotoImage(file='paste1.gif')
lab5=Label(TopF,image=paste_icon)
lab5.pack(side=LEFT)
undo_icon = PhotoImage(file='undo1.gif')
lab6=Label(TopF,image=undo_icon)
lab6.pack(side=LEFT)
redo_icon = PhotoImage(file='redo1.gif')
lab7=Label(TopF,image=redo_icon)
lab7.pack(side=LEFT)
